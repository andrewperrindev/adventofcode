...
- Day 9 (_Movie Theater_): Find largest square formed if two of the given coordinates are opposite corners of the square. Part 2 restricts to squares that are contained only in the polygon formed by the list of points.
